...
const fixtureNewsPosts: readonly FixtureNewsPost[] = [
  ...
  },
  {
    ...
    body: ["이 문단은 상세 본문의 읽기 폭과 간격을 확인하는 개발용 예시입니다.", "실제 시설의 사건, 일정 또는 활동을 나타내지 않습니다."],
    publicationStatus: "published",
    approvalStatus: "approved",
  ...
  },
  {
    ...
    summary: "두 줄 이상 이어지는 긴 요약의 배치와 작은 화면에서의 안전한 줄바꿈을 확인하기 위한 개발용 테스트 데이터이며 실제 활동을 나타내지 않습니다.",
    body: ["이 문단은 상세 본문의 읽기 폭과 간격을 확인하는 개발용 예시입니다.", "실제 시설의 사건, 일정 또는 활동을 나타내지 않습니다."],
    publicationStatus: "published",
    approvalStatus: "approved",
