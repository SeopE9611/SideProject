export const galleryPublicationStatuses = [
  "draft",
  "review",
  "published",
  "archived",
...
export const gallerySubjectPresenceValues = [
  "none",
  "non_identifiable",
  "identifiable",
] as const;
export const galleryConsentStatuses = [
  "not_required",
  "pending",
  "confirmed",
  "withdrawn",
...
export type GalleryPublicationStatus =
  (typeof galleryPublicationStatuses)[number];
export type GalleryApprovalStatus = (typeof galleryApprovalStatuses)[number];
export type GallerySubjectPresence =
  (typeof gallerySubjectPresenceValues)[number];
...
export const isGalleryPublicationStatus = (
  v: unknown,
): v is GalleryPublicationStatus =>
  typeof v === "string" &&
  galleryPublicationStatuses.includes(v as GalleryPublicationStatus);
export const isGalleryApprovalStatus = (
  v: unknown,
): v is GalleryApprovalStatus =>
  typeof v === "string" &&
  galleryApprovalStatuses.includes(v as GalleryApprovalStatus);
export const isGallerySubjectPresence = (
  v: unknown,
): v is GallerySubjectPresence =>
  typeof v === "string" &&
  gallerySubjectPresenceValues.includes(v as GallerySubjectPresence);
export const isGalleryConsentStatus = (v: unknown): v is GalleryConsentStatus =>
  typeof v === "string" &&
  galleryConsentStatuses.includes(v as GalleryConsentStatus);
export const getGalleryPublicationStatusLabel = (v: GalleryPublicationStatus) =>
  publicationLabels[v];
export const getGalleryApprovalStatusLabel = (v: GalleryApprovalStatus) =>
  approvalLabels[v];
export const getGallerySubjectPresenceLabel = (v: GallerySubjectPresence) =>
  subjectLabels[v];
export const getGalleryConsentStatusLabel = (v: GalleryConsentStatus) =>
  consentLabels[v];
...
export function isGalleryConsentReadyForPublication(
  item: ConsentFields,
): boolean {
  ...
  return (
    (item.subjectPresence === "none" ||
      item.subjectPresence === "non_identifiable") &&
...
export function isGalleryConsentWithdrawable(
  item: ConsentFields & { archivedAt: Date | null },
): boolean {
  return (
