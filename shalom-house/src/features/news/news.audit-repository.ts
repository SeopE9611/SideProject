...
const adminAuditFieldLabels: Record<string, string> = { slug: "주소 식별자", category: "분류", title: "제목", summary: "요약", body: "본문", publicationStatus: "게시 상태", approvalStatus: "승인 상태", publishedAt: "게시일" };
