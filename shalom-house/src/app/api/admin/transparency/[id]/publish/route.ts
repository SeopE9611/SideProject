...
import { isValidAdminTransparencyDocumentId, publishAdminTransparencyDocument } from "@/features/transparency/transparency.admin-repository";
...
export async function POST(request: Request, { params }: Context) {
  ...
  try {
    const result = await publishAdminTransparencyDocument({ id, ...validation.value, actor: admin });
