...
import {
  changeAdminProgramPublicationState,
  isValidAdminProgramId,
} from "@/features/programs/program.admin-repository";
import { validateAdminProgramPublicationStateInput } from "@/features/programs/program.admin-validation";
...
export async function POST(request: Request, context: RouteContext) {
  ...
  try {
    ...
    console.error("관리자 프로그램 게시 상태 변경 실패", {
