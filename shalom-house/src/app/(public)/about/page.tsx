      ...
      >
        <div className="mx-auto max-w-site px-page sm:px-page-wide">
          ...
          <h2
            ...
            className="text-safe-wrap mt-3 max-w-3xl text-display font-bold"
          >
          ...
          <div className="mt-8 grid border-t-4 border-primary sm:grid-cols-2">
            <div className="border-b border-border py-6 sm:border-b-0 sm:border-r sm:pr-8">
              <h3 className="text-safe-wrap font-bold">동의와 보호</h3>
              <p className="text-safe-wrap mt-3 text-muted-foreground">
            ...
            <div className="py-6 sm:pl-8">
              <h3 className="text-safe-wrap font-bold">정확한 정보</h3>
              <p className="text-safe-wrap mt-3 text-muted-foreground">
