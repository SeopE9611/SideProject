        ...
        {items.length ? (
          <ul className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {items.map((item) => (
              <li
                key={item.slug}
                className="min-w-0 border-t-4 border-primary py-5"
              >
                ...
                <p className="mt-4 text-small font-bold text-accent">
                  {item.category}
                </p>
                ...
                <p className="text-safe-wrap mt-2 line-clamp-3 text-muted-foreground">
                  {item.description}
                </p>
                <Link
