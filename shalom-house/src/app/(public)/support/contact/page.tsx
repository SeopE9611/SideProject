  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-site px-page py-12 sm:px-page-wide">
        ...
        <p className="mt-5 text-small text-muted-foreground">확인된 경로: {supportFixture.contactPaths.join(", ")}</p>
        <dl className="mt-5 divide-y divide-border border-y">
          <div className="grid gap-2 py-5 sm:grid-cols-3">
            ...
            <dd className="sm:col-span-2">
              <a className="text-primary underline" href={`tel:${siteConfig.phone}`}>
                {siteConfig.phone}
              </a>
            </dd>
          </div>
          <div className="grid gap-2 py-5 sm:grid-cols-3">
            ...
            <dd className="text-safe-wrap sm:col-span-2">{siteConfig.address}</dd>
          </div>
          <div className="grid gap-2 py-5 sm:grid-cols-3">
