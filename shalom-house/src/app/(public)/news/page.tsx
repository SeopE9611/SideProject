      ...
      <header className="border-b border-border">
        <div className="mx-auto max-w-site px-page py-10 sm:px-page-wide sm:py-14">
          <nav aria-label="breadcrumb">
            <Link
              className="text-small text-primary underline underline-offset-4 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus-ring"
              href="/"
            >
              홈
            </Link>
          ...
          <div className="mt-2 flex flex-wrap items-end justify-between gap-5">
            <div>
              <h1 className="text-safe-wrap text-title font-bold sm:text-[2.5rem]">
                소식
              </h1>
              <p className="text-safe-wrap mt-3 max-w-2xl text-body text-muted-foreground">
                공지사항과 활동 소식을 검색하고 분류별로 확인합니다.
              </p>
            </div>
            <a
              ...
              {currentPage > 1 ? (
                <li>
                  <Link
                    ...
                    href={queryHref(currentPage - 1, q, category)}
                  >
                    이전 페이지
                  </Link>
                </li>
                ...
                (number) => (
                  <li key={number}>
                    <Link
                      ...
                      href={queryHref(number, q, category)}
