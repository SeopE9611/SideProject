  ...
  return (
    <div className="space-y-8">
      <header>
        ...
        <h1 className="mt-4 text-title font-bold">연락처·찾아오시는 길 관리</h1>
        ...
        <div className="mt-3 flex gap-4">
          <Link className="underline" href="/about/directions">
            찾아오시는 길 보기
          </Link>
          <Link className="underline" href="/support/contact">
            문의하기 보기
          </Link>
        </div>
      </header>
      <AdminContactInformationForm initialContent={detail.content} expectedUpdatedAt={detail.updatedAt} />
