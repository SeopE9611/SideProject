    ...
    <div className="space-y-8">
      <header>
        ...
        <p className="mt-3 text-body text-muted-foreground">
          현재 게시 상태는 {getNewsPublicationStatusLabel(post.publicationStatus)}이며, 저장 후에도 자동 공개되지
          않습니다.
        </p>
      </header>
      ...
      {!post.isEditable ? (
        ...
        <>
          ...
          <aside
            aria-labelledby="admin-news-edit-safety-heading"
            className="max-w-3xl rounded-card border border-border-strong bg-surface p-5"
          >
            <h2 id="admin-news-edit-safety-heading" className="text-heading font-bold">
              저장 전 안전 확인
            </h2>
          ...
          <section aria-labelledby="admin-news-edit-form-heading">
            <h2 id="admin-news-edit-form-heading" className="sr-only">
              소식 초안 수정
            </h2>
            <AdminNewsDraftForm
              mode="edit"
