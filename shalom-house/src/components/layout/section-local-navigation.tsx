            ...
            return (
              <li key={link.href}>
                <Link
                  ...
                  className={`inline-flex min-h-11 items-center whitespace-nowrap border-b-2 pt-0.5 text-small transition-colors focus-visible:outline-2 focus-visible:outline-offset-[-2px] focus-visible:outline-focus-ring ${
                    isActive
