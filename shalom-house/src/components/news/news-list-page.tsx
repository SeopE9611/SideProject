    ...
    <div className="bg-surface">
      ...
      <div className="mx-auto max-w-site px-page py-8 sm:px-page-wide sm:py-12">
        ...
        >
          ...
          <button
            aria-label="소식 검색"
            className="public-focus-ring inline-flex min-h-13 items-center justify-center gap-2 whitespace-nowrap bg-primary px-3 py-3 font-bold text-primary-foreground transition-colors duration-[var(--motion-duration-fast)] hover:bg-primary-hover focus-visible:outline-offset-4 sm:px-7"
            type="submit"
          >
