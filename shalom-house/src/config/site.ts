  ...
  mainNavigation: [
    {
      ...
      children: [
        ...
        { label: "인사말", description: "공식 인사말 안내", href: "/about/greeting" },
        { label: "함께하는 사람들", description: "직원 역할 안내", href: "/about/people" },
    ...
    },
    {
      ...
      children: [
        ...
        { label: "프로그램", description: "프로그램 분류와 안내", href: "/life/programs" },
        { label: "활동사진", description: "공개 승인된 활동 기록", href: "/life/gallery" },
      ],
    },
    {
      label: "소식",
      ...
      children: [
        ...
        { label: "활동소식", description: "공개된 활동 기록", href: "/news/activities" },
        {
          label: "자료공개",
    ...
    },
    {
      ...
      emphasis: true,
      children: [
        { label: "후원하기", description: "후원 절차 확인", href: "/support/donation" },
        { label: "자원봉사", description: "참여 절차 확인", href: "/support/volunteer" },
        { label: "문의하기", description: "연락 경로 안내", href: "/support/contact" },
      ],
    },
  ],
  footerNavigation: [
