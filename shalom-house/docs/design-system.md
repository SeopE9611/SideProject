...
- 대표색은 남색, 행동 강조는 청록색으로 구분한다. 흰색 본문, 옅은 청회색 기록 영역, 청록색 보조 참여 영역을 각 역할에 맞게 사용한다. 푸터는 남색으로 마감한다. 홈의 정보 순서와 사진 없는 구성은 `page-patterns.md`를 따른다.
...
| 컨테이너                 | `--container-site`, `--container-content`                                                                                                               | `84rem`, `46rem`                                                                         | 전체 사이트 폭과 읽기 폭                       | 유지             |
