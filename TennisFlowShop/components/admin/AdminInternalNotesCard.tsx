...
export default function AdminInternalNotesCard({
  targetType,
  targetId,
  className,
}: {
  ...
  const { data, error, isValidating, mutate } = useSWR<NotesResponse>(
    key,
  ...
  const onCreate = async () => {
    ...
    try {
      ...
      await adminMutator("/api/admin/notes", {
        method: "POST",
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-end gap-2">
                    ...
                    <Button
                      ...
                      disabled={!editingBody.trim() || updatingId === note.id}
                    >
