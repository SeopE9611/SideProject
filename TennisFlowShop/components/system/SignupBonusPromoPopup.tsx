...
export default function SignupBonusPromoPopup({
  ...
  const storageKey = useMemo(
    () => `signup-bonus-promo-dismissed:${promo.campaignId}`,
    [promo.campaignId],
  );
  ...
  return (
    ...
    >
      <DialogContent
        className="sm:max-w-lg p-0 overflow-hidden [&>button]:z-20 [&>button]:bg-background/20 [&>button]:hover:bg-background/30 [&>button]:text-foreground"
