...
export function ResultState({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "mb-5 flex size-12 items-center justify-center rounded-full border text-xs font-semibold",
          statusStyles[status],
        )}
        aria-hidden="true"
      >
      ...
      {description && (
        <div className="mt-3 max-w-xl text-sm text-muted-foreground sm:text-base">
          {description}
        </div>
      )}
