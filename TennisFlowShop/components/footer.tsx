          ...
          <SiteContainer variant="wide">
            <div className="space-y-3 text-xs text-muted-foreground">
              <div className="space-y-1">
                <p className="font-semibold text-foreground">도깨비테니스</p>
                <p className="break-keep">
                  고객센터 010-5218-5248 · 평일 10:00 - 22:00
                </p>
              </div>
            ...
            <div className="space-y-6 bp-sm:space-y-8">
              <div className="grid w-full grid-cols-1 gap-y-6 pb-5 bp-sm:grid-cols-2 bp-sm:gap-x-8 bp-sm:gap-y-7 bp-sm:pb-6 bp-lg:grid-cols-[1.15fr_1fr_1fr_1fr] bp-lg:gap-x-8 bp-xl:grid-cols-[1.15fr_1fr_1fr_1fr_0.85fr]">
                <section className="flex min-w-0 w-full flex-col items-start gap-3">
                  <h3 className="text-sm font-semibold text-foreground bp-sm:text-base">
                    고객센터
                  </h3>
                  ...
                  <div className="flex flex-col items-start gap-2.5">
                    {snsLinks.map(({ name, href, Icon }) => (
                      <Link
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center gap-2 text-xs font-medium text-muted-foreground/95 transition-colors hover:text-primary"
                      >
                        {Icon ? (
              ...
              <div className="flex flex-col gap-4 bp-md:flex-row bp-md:items-center bp-md:justify-between">
                <div className="min-w-0 space-y-2.5 text-xs leading-5 text-muted-foreground/95 bp-sm:text-[13px]">
                  ...
                  <p className="text-foreground/85">
                    상호: 도깨비테니스 | 대표: 김재민 | 사업자등록번호:
                    329-39-01593 | 통신판매업신고: 제 2026 - 서울동작 - 0548 호
                  </p>
                ...
                >
                  ...
                  <div className="space-y-1.5 text-left">
                    <div className="font-brand-bold text-xl font-bold tracking-normal text-foreground bp-sm:text-2xl">
                      도깨비테니스
                    </div>
                    <div className="text-[11px] font-semibold tracking-[0.08em] text-muted-foreground/80 bp-sm:text-xs">
                      스트링 · 라켓 · 아카데미
                    </div>
                  </div>
                </Link>
