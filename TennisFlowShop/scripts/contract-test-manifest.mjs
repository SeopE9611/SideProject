...
export const coreContractFiles = [
  ...
  "apps-in-toss-activity.contract.test.mjs",
  "apps-in-toss-live-readiness.contract.test.mjs",
  "apps-in-toss-payment-execution.contract.test.mjs",
  "apps-in-toss-payment-snapshot.contract.test.mjs",
  "apps-in-toss-payment-finalization.contract.test.mjs",
  "apps-in-toss-racket-purchase-idempotency.core.test.mjs",
  "apps-in-toss-racket-rental.core.test.mjs",
  "racket-paid-rental-availability.core.test.mjs",
  ...
  "apps-in-toss-admin-recovery.contract.test.mjs",
...
export const advisoryContractFiles = [
  ...
  "portfolio-demo-readonly.advisory.test.mjs",
