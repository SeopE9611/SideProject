...
const indexSpecs = [
  {
    ...
    options: { name: "orders_userId_createdAt" },
  },
  {
    collection: "stringing_applications",
    keys: { userId: 1, createdAt: -1 },
    options: { name: "apps_userId_createdAt" },
  },
  {
    collection: "reviews",
    keys: { userId: 1, createdAt: -1 },
    options: { name: "reviews_userId_createdAt" },
  },
  {
    collection: "user_audit_logs",
    keys: { userId: 1, at: -1 },
    options: { name: "audit_userId_at" },
  },
  {
    collection: "user_sessions",
    keys: { userId: 1, at: -1 },
    options: { name: "sessions_userId_at" },
  },
];
