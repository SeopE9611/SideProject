...
try {
  ...
  const academySpecs = [[plan.academy_lesson_applications[0], c1, "submitted", "beginner", ["화", "목"], "19:00 이후"], [plan.academy_lesson_applications[1], c2, "reviewing", "intermediate", ["수", "금"], "오전 10:00~12:00"], [plan.academy_lesson_applications[2], c3, "confirmed", "new", ["토"], "14:00"]];
