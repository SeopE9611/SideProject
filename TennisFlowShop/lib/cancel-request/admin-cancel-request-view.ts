...
export function normalizeAdminCancelRequestStatus(rawStatus?: string | null): AdminCancelRequestViewStatus {
...
export function buildAdminCancelRequestView(
  ...
  const reasonSummary = reasonCode ? `${reasonCode}${reasonText ? ` (${reasonText})` : ''}` : reasonText;
