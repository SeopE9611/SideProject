...
export const MARKET_RACKET_PATTERN_OPTIONS = [
  "16x19",
  "18x20",
  "16x18",
  "16x20",
...
export const MARKET_STRING_GAUGE_OPTIONS = [
  "1.15",
  "1.20",
  "1.23",
  "1.25",
...
export const MARKET_STRING_COLOR_OPTIONS = [
  "white",
  "black",
  "silver",
  "blue",
...
export const MARKET_RACKET_FIELD_LABEL_MAP: Record<
  keyof Pick<
    MarketRacketSpec,
    | "weight"
    | "balance"
...
export function isMarketBrandCategory(
  category: string | null | undefined,
): category is "racket" | "string" {
...
export const isBrandRequiredCategory = (category: string | null | undefined) =>
...
export function normalizeMarketMeta(
  category: string | null | undefined,
  meta: any,
): MarketMeta | null {
