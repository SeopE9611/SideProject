...
export const DEFAULT_PACKAGE_CONFIGS: PackageConfig[] = [
  {
    ...
    features: ['10회 스트링 교체', '3개월 유효기간', '매장 방문 서비스'],
    isActive: true,
    isPopular: false,
    validityDays: 90,
    sortOrder: 1,
  },
  {
    ...
    features: ['30회 스트링 교체', '6개월 유효기간', '매장 방문 서비스', '우선 예약'],
    isActive: true,
    isPopular: true,
    validityDays: 180,
    sortOrder: 2,
  },
  {
    ...
    features: ['50회 스트링 교체', '9개월 유효기간', '매장 방문 서비스', '우선 예약', '전용 상담'],
    isActive: true,
    isPopular: false,
    validityDays: 270,
    sortOrder: 3,
  },
  {
    ...
    features: ['100회 스트링 교체', '12개월 유효기간', '매장 방문 서비스', '우선 예약', '전용 상담', 'VIP 혜택'],
    isActive: true,
    isPopular: false,
    validityDays: 365,
    sortOrder: 4,
