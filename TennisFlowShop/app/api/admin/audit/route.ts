...
function actorDisplay(doc: UnknownRecord) {
  ...
  const name =
    (metadataActor.name as string | undefined) ??
    (diff.actorName as string | undefined) ??
    (doc.actorName as string | undefined) ??
    null;
  const email =
    (metadataActor.email as string | undefined) ??
    (diff.actorEmail as string | undefined) ??
    (doc.actorEmail as string | undefined) ??
    null;
  const role =
    (metadataActor.role as string | undefined) ??
