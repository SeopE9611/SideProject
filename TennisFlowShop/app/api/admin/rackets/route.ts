    ...
    spec: {
      ...
      headSize:
        body.spec?.headSize != null && body.spec?.headSize !== ""
          ...
          : null,
      lengthIn:
        body.spec?.lengthIn != null && body.spec?.lengthIn !== ""
          ? Number(body.spec.lengthIn)
          : null,
      swingWeight:
        body.spec?.swingWeight != null && body.spec?.swingWeight !== ""
          ? Number(body.spec.swingWeight)
          : null,
      stiffnessRa:
        body.spec?.stiffnessRa != null && body.spec?.stiffnessRa !== ""
          ? Number(body.spec.stiffnessRa)
          : null,
