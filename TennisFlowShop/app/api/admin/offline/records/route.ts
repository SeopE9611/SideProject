...
function serializeRecord(d: Record<string, any>) {
  return {
    ...
    points: {
      ...
      grantRevertedAt: d.points?.grantRevertedAt instanceof Date ? d.points.grantRevertedAt.toISOString() : d.points?.grantRevertedAt ?? null,
      grantRevertedBy: d.points?.grantRevertedBy ? String(d.points.grantRevertedBy) : null,
      grantRevertReason: typeof d.points?.grantRevertReason === "string" ? d.points.grantRevertReason : null,
      deductRevertTxId: d.points?.deductRevertTxId ? String(d.points.deductRevertTxId) : null,
      deductRevertedAt: d.points?.deductRevertedAt instanceof Date ? d.points.deductRevertedAt.toISOString() : d.points?.deductRevertedAt ?? null,
      deductRevertedBy: d.points?.deductRevertedBy ? String(d.points.deductRevertedBy) : null,
      deductRevertReason: typeof d.points?.deductRevertReason === "string" ? d.points.deductRevertReason : null,
    },
    packageUsage: {
