...
export async function PATCH(req: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  if (("reminderEnabled" in value && value.reminderEnabled && !current.reminderEnabled) || ("lastStringingAt" in value && value.lastStringingAt.getTime() !== current.lastStringingAt.getTime())) $set.reminderSentFor = null;
