  ...
  try {
    ...
    try {
      ...
      const rental = await createRentalOrderCore({
        ...
        client,
        userObjectId:
          session.userId && ObjectId.isValid(session.userId) ? new ObjectId(session.userId) : null,
        payload: {
          ...rentalPayload,
        ...
        paidMetadata: {
          ...
          paymentStatus: "결제완료",
          paymentInfo: {
            ...(rentalPayloadAny?.paymentInfo && typeof rentalPayloadAny.paymentInfo === "object"
