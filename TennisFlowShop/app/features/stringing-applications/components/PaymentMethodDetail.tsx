    ...
    <div className="space-y-2">
      ...
      <div className="flex flex-col gap-1">
        ...
        {!isPackagePayment && !isTossPayment && !isNicePayment && !bankInfo && (
          <div className="mt-1 rounded-md border border-border bg-background px-3 py-2 text-sm text-foreground/90 leading-relaxed">{resolvedMethodLabel || "결제 정보 확인 필요"}</div>
        )}
