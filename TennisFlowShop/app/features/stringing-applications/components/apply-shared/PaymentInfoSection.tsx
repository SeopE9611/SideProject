...
export default function PaymentInfoSection({ formData, setFormData, handleInputChange, usingPackage, packagePreview, packageInsufficient, packageRemaining, requiredPassCount }: PaymentInfoSectionProps) {
  return (
