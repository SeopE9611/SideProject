...
export function OrderStatusFilter({ value, onChange }: Props) {
  return (
    <Select value={value} onValueChange={onChange}>
      <SelectTrigger className="w-full h-9 text-ui-label" aria-label="주문 상태 필터">
      ...
      <SelectContent>
        ...
        <SelectItem value="배송중">배송중 / 수령 준비중</SelectItem>
        <SelectItem value="배송완료">배송완료 / 방문 수령 완료</SelectItem>
