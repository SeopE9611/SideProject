      ...
      <div className="relative grid gap-9 bp-lg:grid-cols-[minmax(0,1.08fr)_minmax(380px,0.92fr)] bp-lg:items-center">
        <div className="space-y-6">
          ...
          <p className="max-w-xl break-keep text-ui-body text-muted-foreground">
            마지막 교체일과 플레이 빈도를 연결하면 상태 점수, 예상 교체일, 맞춤 추천까지 하나의
            흐름으로 관리할 수 있습니다.
          </p>
          ...
          <Card variant="feature" className="relative mx-auto max-w-md rounded-panel shadow-float">
            <CardContent className="p-5 bp-sm:p-6">
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  ...
                  <p className="text-ui-label text-muted-foreground">
                    실제 사용자 데이터가 아닌 고정 샘플입니다.
                  </p>
                </div>
                <Badge variant="warning" wrap="nowrap" className="shrink-0">
                  교체 준비
                </Badge>
              </div>
              <div className="mx-auto mt-6 grid w-full max-w-[230px] place-items-center">
                ...
                >
                  <svg
                    className="absolute inset-0 h-full w-full -rotate-90 text-brand-highlight"
                    viewBox="0 0 120 120"
                    aria-hidden="true"
                  >
                    <circle
              ...
              <div className="mt-6 grid grid-cols-3 gap-2">
                <div className="rounded-control border border-border bg-card p-3">
                  <p className="text-ui-micro text-muted-foreground">예상 교체</p>
                  <p className="mt-1 break-keep text-ui-label font-semibold">D-12</p>
                </div>
                <div className="rounded-control border border-border bg-card p-3">
                  <p className="text-ui-micro text-muted-foreground">플레이 빈도</p>
                  <p className="mt-1 break-keep text-ui-label font-semibold">주 2~3회</p>
                </div>
                <div className="rounded-control border border-border bg-card p-3">
                  <p className="text-ui-micro text-muted-foreground">최근 스트링</p>
                  <p className="mt-1 break-keep text-ui-label font-semibold">예시 스트링</p>
                </div>
              </div>
              <div className="mt-5 flex gap-3 rounded-control bg-brand-highlight-muted p-4 text-left">
                ...
                <p className="break-keep text-ui-body-sm text-muted-foreground">
                  예시 화면입니다. 상태 점수와 예상 교체일은 마지막 교체일과 플레이 빈도에 따른 관리
                  지표이며, 실제 스트링 마모 상태와 다를 수 있습니다.
                </p>
              </div>
            </CardContent>
          </Card>
