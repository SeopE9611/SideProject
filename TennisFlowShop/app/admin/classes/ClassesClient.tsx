          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-foreground">
                  {classes.filter((c) => c.status === "recruiting").length}
                </p>
              </div>
              <div className="bg-primary/10 rounded-xl p-3 text-foreground dark:bg-primary/20">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-foreground">
                  {classes.filter((c) => c.status === "closed").length}
                </p>
              </div>
            ...
            <div className="flex w-full max-w-sm items-center space-x-2">
              <div className="relative flex-1">
                ...
                <Input
                  ...
                  className="pl-10 border-border focus:border-border focus:ring-ring"
                />
              </div>
            </div>
          ...
          {selectedClasses.length > 0 && (
            <div className="mb-4 flex items-center gap-2 rounded-lg bg-primary/10 p-3 text-foreground dark:bg-primary/20">
              <span className="text-sm font-medium text-primary">
                {selectedClasses.length}개의 클래스가 선택됨
              </span>
              <div className="ml-auto flex gap-2">
                <Button
                  variant="outline"
                  size="sm"
                  className="h-8 border-border text-primary hover:bg-primary/10 dark:hover:bg-primary/20 bg-transparent"
                >
              ...
              <TableBody>
                {filteredClasses.length > 0 ? (
                  filteredClasses.map((cls) => (
                    <TableRow
                      key={cls.id}
                      className="hover:bg-background dark:hover:bg-card transition-colors"
                    >
                      <TableCell>
                        <Checkbox
                        ...
                        <DropdownMenu>
                          <DropdownMenuTrigger asChild>
                            <Button
                              variant="ghost"
                              size="sm"
                              className="h-8 w-8 p-0 hover:bg-background dark:hover:bg-card"
                            >
