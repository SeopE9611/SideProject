...
export default function AcademyClassFormClient({ mode, initialItem }: AcademyClassFormClientProps) {
  ...
  return (
    <div className="space-y-5 px-4 py-6 sm:px-8">
      ...
      <form className="space-y-5" onSubmit={submitForm}>
        ...
        <div className="flex gap-2 border-t border-border/70 pt-5 flex-row justify-end">
