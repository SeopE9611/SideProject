      ...
      : needsPaymentCheck
        ...
        : isBeforeOut && hasLinkedApplication && !isStringingComplete
          ? {
              ...
              title: "교체 작업 완료 필요",
              description:
                "대여에 포함된 교체 작업이 완료된 뒤 대여 라켓 인도 또는 대여 시작을 진행하세요.",
            }
  ...
  return (
    <AdminPageShell variant="wide" className="lg:py-8">
      ...
      <div className="mx-auto w-full max-w-[1500px] space-y-6 lg:space-y-8">
        ...
        {linkedApplication && (
          <Card id="admin-rental-linked-docs" className={cn(adminSurface.card, "overflow-hidden")}>
            ...
            <CardContent className="space-y-3 pt-4">
                ...
                <p className="text-muted-foreground">
                  ...
                  <span className="font-medium text-foreground">
                    {linkedApplicationStrings.join(", ") ||
                      (Array.isArray(data?.stringingNames) ? data.stringingNames.join(", ") : "") ||
                      stringingName ||
              ...
              <div className="space-y-1 text-xs leading-relaxed text-muted-foreground">
                <p>
                  이 작업은 대여에 포함된 교체 작업 상태만 변경합니다. 대여 결제, 인도 운송장 등록,
                  대여 시작, 반납 처리는 기존 대여 액션에서 별도로 진행하세요.
                </p>
                  ...
                  <div className="space-y-3">
                    ...
                    {hasLegacyRefundAccount && (
                      ...
                      >
                        ...
                        <p className="mt-1 text-xs text-foreground/75">
                          기존에 등록된 보증금 환불 계좌입니다. 취소 요청 계좌가 없을 때 참고용으로
                          확인하세요.
                        </p>
                        <dl className="mt-3 space-y-1 text-sm text-foreground">
                          <div className="grid grid-cols-[72px_minmax(0,1fr)] gap-2">
