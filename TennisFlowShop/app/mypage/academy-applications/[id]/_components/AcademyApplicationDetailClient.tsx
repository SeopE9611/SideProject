      ...
      <SummaryCard
        ...
        action={
          <Button
            ...
            variant="ghost"
            size="sm"
            className="w-full justify-start px-0 hover:bg-transparent bp-sm:w-auto"
          >
            <Link href="/mypage?tab=academy">
              <ArrowLeft className="h-4 w-4" />
              클래스 신청 목록
      ...
      >
        <div className="flex flex-col gap-4 bp-sm:flex-row bp-sm:items-start bp-sm:justify-between">
          <div className="min-w-0 space-y-2">
            ...
            <h2 className="break-words text-2xl font-bold leading-tight text-foreground bp-sm:text-3xl">
