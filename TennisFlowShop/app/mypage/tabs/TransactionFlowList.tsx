            ...
            <Card key={g.key} className="group relative overflow-hidden border border-border bg-card shadow-sm transition-[box-shadow,border-color,background-color] duration-200 hover:shadow-md">
              ...
              <CardContent className="relative space-y-4 p-4 bp-sm:p-6">
                ...
                {todoPrimaryReason && nextActionText ? (
                  <div className={`rounded-xl border p-3 bp-sm:p-4 ${scope === "todo" ? "border-primary/30 bg-primary/5 ring-1 ring-primary/10 dark:bg-primary/10" : "border-border/60 bg-secondary/40"}`}>
                ...
                <div className="flex flex-wrap items-center justify-end gap-2 border-t border-border/60 pt-3 md:pt-4 [&_button]:whitespace-nowrap">
                  {(() => {
                    ...
                    const resolvedDetailLabel = hasOrderLinkedApplication ? "이용 상세 보기" : "상세 보기";
