...
export default function NoticeListClient({
  ...
  const noticeMobileActionGroupClass =
            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
              ...
              <div>
                ...
                <p className="text-sm sm:text-base text-muted-foreground">
                  테니스 플로우 고객센터의 주요 안내와 공지사항을 확인하실 수
                  있습니다.
                </p>
              </div>
            </div>
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="mb-1 flex flex-wrap items-start justify-between gap-2">
                                <div className="flex min-w-0 flex-1 items-center gap-2 flex-wrap">
                                  ...
                                  <span
                                    className={`${noticeMobileTitleClampClass} text-foreground transition-colors hover:text-primary dark:hover:text-primary`}
                                  >
                                    {notice.title}
                                  </span>
                                </div>
              ...
              <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3">
                ...
                {visiblePages.map((pageNumber) => (
                  <Button
                    ...
                    className={
                      pageNumber === page
                        ? "h-10 w-10 sm:h-12 sm:w-12 bg-primary text-primary-foreground border-border text-sm sm:text-base"
