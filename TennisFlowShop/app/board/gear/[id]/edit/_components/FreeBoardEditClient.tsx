...
export default function FreeBoardEditClient({ id }: Props) {
  ...
  const [category, setCategory] = useState<
    "racket" | "string" | "shoes" | "bag" | "apparel" | "grip" | "accessory" | "ball" | "other"
  >("racket");
  ...
  if (isLoading) {
    return <CommunityBoardEditLoadingShell boardLabel="장비 사용기" />;
  }
                    ...
                    <Button
                      ...
                      onClick={async () => {
                        ...
                        try {
                          ...
                          console.error("최신 장비 사용기 글 재조회 실패", error);
