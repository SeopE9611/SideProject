    ...
    <div className="min-h-screen bg-background pb-28 bp-lg:pb-0">
      <SiteContainer className="py-6 bp-md:py-8">
        <div className="mx-auto max-w-6xl space-y-5">
          ...
          <div className="grid grid-cols-3 gap-2 rounded-panel border border-border bg-card p-3 shadow-soft">
          ...
          <Card className="rounded-panel border-border bg-card shadow-soft">
            <CardContent className="space-y-4 p-4 bp-sm:p-5">
              ...
              <div className="rounded-panel border border-border bg-card p-3">
                <div className="flex flex-col gap-2 bp-lg:flex-row">
          ...
          <div className="grid gap-5 bp-lg:grid-cols-[minmax(0,1fr)_320px] bp-lg:items-start">
            <Card className="rounded-panel border-border bg-card shadow-soft">
              <CardContent className="space-y-7 p-4 bp-sm:p-6">
                ...
                <div className="flex justify-end gap-2">
                  ...
                  <Skeleton className="hidden h-11 w-28 bp-lg:block" />
                </div>
              </CardContent>
            </Card>
      ...
      <div
        ...
        className="fixed inset-x-0 bottom-0 z-40 border-t border-border bg-card px-4 pb-[calc(env(safe-area-inset-bottom)+0.75rem)] pt-3 bp-lg:hidden"
      >
