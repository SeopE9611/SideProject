...
type OrderItemLike =
  | { name?: string; price?: NumericLike; quantity?: NumericLike }
  | null
  | undefined;
...
export default async function CheckoutSuccessPage({
  ...
  const isGuestOwner = !!(
    ...
    orderAccessPayload.orderId === String(order._id)
  );
                ...
                <div className="rounded-xl border border-border bg-card/10 p-4 md:p-6 text-center backdrop-blur-sm">
                  ...
                  {hasSubmittedApplication ? (
                    <div className="space-y-3 text-sm text-muted-foreground">
                      <p>
                        별도 신청서 작성 없이 현재 주문에 포함되어 처리됩니다.
                      </p>
        ...
        <SiteContainer variant="wide" className="py-8">
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <Card
              ...
              className="overflow-hidden border border-border bg-card shadow-2xl backdrop-blur-sm"
            >
                  ...
                  <div className="space-y-2 rounded-lg border border-border bg-background p-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <span className="ml-2 font-semibold text-foreground">
                          {order.shippingInfo?.phone || "정보 없음"}
                        </span>
                      </div>
                    </div>
                ...
                <div className="rounded-xl border border-border bg-background p-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      {formatPrice(order.shippingFee)}원 포함)
                    </p>
                  </div>
                </div>
              </CardContent>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3 rounded-lg border border-border bg-background p-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {isVisitPickup
                            ? "방문 수령 관련 문의사항은 고객센터(02-123-4567)로 연락주세요."
                            : "배송 관련 문의사항은 고객센터(02-123-4567)로 연락주세요."}
                        </p>
                      </div>
                    </div>
                  </div>
