                        ...
                        <div>
                          ...
                          {isZeroPayment ? (
                            ...
                            <>
                              ...
                              {isNicePayment && <p className="text-sm text-muted-foreground">결제수단: 카드/간편결제</p>}
                            </>
                          )}
                        </div>
                      </div>
                    ...
                    <div className="rounded-xl border border-border bg-background p-6">
                      ...
                      {isZeroPayment ? (
                        ...
                        <div className="space-y-2 rounded-lg border border-border bg-card p-4 text-sm">
                          ...
                          <p>
                            <span className="text-muted-foreground">결제 수단:</span> <span className="font-semibold text-foreground">카드/간편결제</span>
                          </p>
                          {easyPayProviderLabel && (
                            <p>
                              <span className="text-muted-foreground">간편결제:</span> <span className="font-semibold text-foreground">{easyPayProviderLabel}</span>
