...
const fmtFixed = (n: number, decimals = 0) =>
...
type Row =
  | {
      ...
      hint?: string;
      kind: "text";
      get: (r: CompareRacketItem) => string;
    }
  | {
      key: string;
      label: string;
    ...
    () => [
      {
        ...
        label: "브랜드",
        kind: "text",
        get: (r) => racketBrandLabel(r.brand),
      },
      { key: "model", label: "모델", kind: "text", get: (r) => r.model },
      {
        ...
        label: "연식",
        kind: "text",
        get: (r) => (r.year ? String(r.year) : "-"),
      },
      {
        key: "condition",
        label: "컨디션",
        kind: "text",
        get: (r) => (r.condition ? String(r.condition) : "-"),
      },
      {
        key: "price",
        label: "가격",
        ...
        <div className="flex flex-col bp-sm:flex-row bp-sm:items-start bp-sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              className="inline-flex items-center gap-2 rounded-lg text-muted-foreground hover:text-destructive hover:ring-destructive/30"
            >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {list.map((r, idx) => (
                      <div
                        key={r.id}
                        className={cn(
                          "group flex items-center gap-3 rounded-lg p-2 pr-3",
                          "bg-muted/30",
                      ...
                      >
                        <div
                          className={cn(
                            "relative h-12 w-12 overflow-hidden rounded-md bg-muted/50",
                            "ring-1 ring-border/10",
                          )}
                        >
                          {r.image ? (
                            <Image
                              ...
                              alt={`${racketBrandLabel(r.brand)} ${r.model}`}
                              fill
                        ...
                        <Button
                          ...
                          size="icon"
                          onClick={() => remove(r.id)}
                          className="h-7 w-7 ml-1 opacity-0 group-hover:opacity-100 transition-opacity text-muted-foreground hover:text-destructive"
                          aria-label="비교에서 제거"
                        >
                    ...
                    {list.map((r, idx) => (
                      ...
                      >
                        ...
                        <div className="mt-3 flex items-center gap-3">
                          <div
                            className={cn(
                              "relative h-14 w-14 overflow-hidden rounded-lg bg-muted/50",
                              "ring-1 ring-border/10",
                              !r.image && "flex items-center justify-center",
                            )}
                          >
                            {r.image ? (
                              <Image
