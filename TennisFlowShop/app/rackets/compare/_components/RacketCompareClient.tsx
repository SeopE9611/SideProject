...
const RacketSpecQuickViewDialog = dynamic(() => import("@/app/rackets/compare/_components/RacketSpecQuickViewDialog"), { loading: () => null });
                    ...
                    return (
                      <tr key={row.key} className="hover:bg-muted/20 dark:hover:bg-muted/10 transition-colors">
                        ...
                        {list.map((r, idx) => {
                          ...
                          const barClass = delta === null ? "bg-secondary" : delta > 0 ? "bg-secondary" : delta < 0 ? "bg-destructive/10 dark:bg-destructive/20" : "bg-muted/30";
