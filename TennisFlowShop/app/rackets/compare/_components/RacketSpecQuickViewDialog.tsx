...
function SpecRow({
  ...
  return (
    <div
      className={cn(
        "group flex items-center justify-between gap-3 px-3 py-2.5 bp-sm:px-4 bp-sm:py-3",
    ...
    >
      <div className="flex items-center gap-2 bp-sm:gap-3">
        ...
        >
          <IconComponent
            className={cn(
              "h-3.5 w-3.5 bp-sm:h-4 bp-sm:w-4",
              ...
              <div className="space-y-3 bp-sm:space-y-4">
                ...
                <div
                  className={cn(
                    ...
                    "bg-background ring-1 ring-muted-foreground/10",
                    "transition-shadow duration-300",
                    "hover:ring-muted-foreground/20 hover:shadow-sm",
                  )}
                >
                  {specRows.map((row, index) => (
                    <SpecRow
                      ...
                      label={row.label}
                      value={row.value}
                      isLast={index === specRows.length - 1}
                    />
                  ))}
                </div>
