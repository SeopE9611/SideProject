...
> = {
  ...
  INVALID_QUERY: {
    ...
    description: ["결제 결과 확인 중 필수 값이 누락되었어요.", "라켓 구매 페이지에서 다시 결제를 진행해주세요."],
  },
  CONFIRM_FAILED: {
  ...
  AMOUNT_MISMATCH: {
    ...
    description: ["결제 금액이 주문 정보와 일치하지 않아 결제가 중단되었어요.", "라켓 구매 페이지에서 금액을 다시 확인해주세요."],
  },
  SESSION_NOT_FOUND: {
  ...
  SESSION_EXPIRED: {
    ...
    description: ["결제 준비 시간이 지나 결제를 이어갈 수 없어요.", "라켓 구매 페이지에서 다시 결제를 진행해주세요."],
  },
