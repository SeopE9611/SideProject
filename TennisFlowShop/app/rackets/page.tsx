      ...
      <div className="relative overflow-hidden bg-muted/30 py-10 bp-sm:py-12 bp-md:py-24">
        ...
        <SiteContainer variant="wide" className="relative">
          <div className="text-center text-foreground">
            ...
            <p className="text-base bp-sm:text-lg bp-md:text-xl mb-5 bp-sm:mb-6 bp-md:mb-8 text-muted-foreground max-w-3xl mx-auto leading-relaxed px-4">검수된 중고 라켓 구매·대여와 스트링 교체를 동시에 신청하세요.</p>
            ...
            <p className="mt-2 text-sm text-muted-foreground">무게·밸런스 등 상세 스펙으로 바로 찾아보세요</p>
          </div>
        </SiteContainer>
      </div>
        ...
        {from === "apply" && (
          <div className="mb-4 rounded-xl border border-border bg-card p-3 shadow-sm bp-sm:p-4">
            <div className="flex flex-col gap-3 bp-md:flex-row bp-md:items-center bp-md:justify-between">
              ...
              <Button asChild size="sm" variant="outline" className="h-9 w-full whitespace-nowrap border-border bg-card text-foreground bp-sm:w-auto">
