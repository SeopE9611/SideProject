  ...
  const privacySections = [
    {
      ...
      icon: FileText,
      content: `도깨비테니스스트링는 회원 가입, 상담, 서비스 신청 등을 위해 아래와 같은 개인정보를 수집하고 있습니다.
...
- 생성정보 수집 툴을 통한 수집`,
    },
    {
      ...
      title: "2. 개인정보 수집 방법",
      icon: Eye,
      content: `도깨비테니스스트링는 다음과 같은 방법으로 개인정보를 수집합니다.
...
회사는 이용자의 개인정보를 수집할 경우 반드시 사전에 이용자에게 해당 사실을 알리고 동의를 구하고 있습니다. 또한 회사는 이용자의 기본적 인권을 침해할 우려가 있는 민감한 개인정보(인종, 민족, 사상, 신조, 출신지, 정치적 성향, 범죄기록, 건강상태 등)는 수집하지 않습니다.`,
    },
    {
      ...
      title: "3. 개인정보의 이용 목적",
      icon: Users,
      content: `도깨비테니스스트링는 수집한 개인정보를 다음의 목적을 위해 활용합니다.
...
- 신규 서비스(제품) 개발 및 특화, 이벤트 등 광고성 정보 전달, 인구통계학적 특성에 따른 서비스 제공 및 광고 게재, 접속 빈도 파악 또는 회원의 서비스 이용에 대한 통계`,
    },
    {
      ...
      icon: RefreshCw,
      content: `도깨비테니스스트링는 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다. 단, 다음의 정보에 대해서는 아래의 이유로 명시한 기간 동안 보존합니다.
...
- 웹사이트 방문기록: 3개월 (통신비밀보호법)`,
    },
    {
      ...
      title: "5. 개인정보 제3자 제공",
      icon: Users,
      content: `도깨비테니스스트링는 원칙적으로 이용자의 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서 처리하며, 이용자의 사전 동의 없이는 본래의 범위를 초과하여 처리하거나 제3자에게 제공하지 않습니다. 단, 다음의 경우에는 개인정보를 처리할 수 있습니다.
...
현재 도깨비테니스스트링는 이용자의 개인정보를 제3자에게 제공하고 있지 않습니다. 향후 제3자 제공이 필요한 경우, 이용자에게 사전 동의를 구하고 관련 법령에 따라 처리하겠습니다.`,
    },
    {
      id: "user-rights",
...
권리 행사는 이용자의 법정대리인이나 위임을 받은 자 등 대리인을 통하여 하실 수도 있습니다. 이 경우 개인정보 보호법 시행규칙 별지 제11호 서식에 따른 위임장을 제출하셔야 합니다.`,
    },
    {
      ...
      icon: Lock,
      content: `도깨비테니스스트링는 이용자의 개인정보를 취급함에 있어 개인정보가 분실, 도난, 누출, 변조 또는 훼손되지 않도록 안전성 확보를 위하여 다음과 같은 기술적/관리적 대책을 강구하고 있습니다.
...
- 개인정보 관련 취급자의 업무 인수인계는 보안이 유지된 상태에서 철저하게 이뤄지고 있으며 입사 및 퇴사 후 개인정보 사고에 대한 책임을 명확화하고 있습니다.`,
    },
    {
      ...
      icon: Cookie,
      content: `도깨비테니스스트링는 이용자에게 개인화되고 맞춤화된 서비스를 제공하기 위해 쿠키(cookie)를 사용합니다.
...
- 2023년 12월 1일: 개인정보처리방침 제정`,
    },
    {
      ...
      icon: Mail,
      content: `도깨비테니스스트링는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
      ...
      <div className="border-b">
        <div className="container py-8 max-w-5xl">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground max-w-3xl leading-relaxed">도깨비테니스스트링(이하 '회사')는 이용자의 개인정보를 중요시하며, 「개인정보 보호법」을 준수하기 위하여 노력하고 있습니다.</p>
