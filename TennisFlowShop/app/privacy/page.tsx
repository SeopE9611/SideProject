...
도깨비테니스는 현재 맞춤형 광고 또는 광고 목적의 이용자 행동 분석을 위해 개인정보를 이용하지 않습니다. 해당 기능을 도입하는 경우 처리방침을 변경하고 필요한 동의 절차를 마련합니다.`,
    },
    {
      ...
      icon: RefreshCw,
      content: `도깨비테니스는 개인정보의 처리 목적이 달성되거나 보유기간이 종료되면 해당 정보를 지체 없이 파기합니다. 다만, 관련 법령에 따라 일정 기간 보존해야 하는 정보는 회원 계정 정보와 구분하여 해당 기간 동안 보관합니다.

회원 계정 및 프로필 정보
- 보유기간: 회원 탈퇴 시까지
- 탈퇴 시 이름, 이메일, 휴대전화번호, 주소, 비밀번호 및 소셜 로그인 연결정보를 즉시 삭제하거나 비식별 처리합니다.
- 진행 중인 주문, 대여, 교체 서비스 또는 사용 가능한 패키지가 있는 경우에는 해당 처리가 완료된 후 탈퇴할 수 있습니다.

탈퇴 사유 및 상세 의견
- 이용 목적: 서비스 개선과 탈퇴 원인 확인
- 보유기간: 탈퇴일로부터 180일
- 회원 식별정보와 분리하여 저장하고 보유기간 종료 후 자동 삭제합니다.

로그인 보안 기록
- 항목: 접속 IP, 사용자 에이전트, 로그인 시각
- 이용 목적: 비정상 로그인 확인과 부정 이용 방지
- 보유기간: 생성일로부터 90일
- 보유기간 종료 후 자동 삭제합니다.
...
법령에 따라 보존하는 거래기록은 해당 목적 외의 용도로 이용하지 않으며, 보존기간이 종료되면 파기합니다.

파기 절차 및 방법
- 보유기간 종료 또는 처리 목적 달성 여부를 확인하여 파기 대상 정보를 선정합니다.
- 전자적 파일과 데이터베이스 기록은 복구 또는 재생하기 어렵도록 삭제합니다.
- 브라우저에 저장된 쿠키, 로컬 스토리지 및 세션 스토리지 정보는 로그아웃, 회원 탈퇴, 보관기간 만료 또는 이용자의 브라우저 데이터 삭제를 통하여 제거할 수 있습니다.`,
    },
    {
      id: "third-party",
      title: "5. 개인정보 제3자 제공",
...
개인정보처리방침 변경 이력
- 2026년 8월 28일: 실제 개인정보 수집 항목, 보유기간, 파기 기준, 안전성 확보조치 및 쿠키·브라우저 저장 기술 안내 정비
