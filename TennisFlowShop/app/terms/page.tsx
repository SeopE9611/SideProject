    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container py-12 max-w-5xl">
        <div className="space-y-12">
          {/* Introduction */}
          <div className="space-y-4">
            <p className="text-foreground/80 leading-relaxed">도깨비테니스(이하 '회사')는 이용자의 권리를 보호하고 안전하고 편리한 서비스를 제공하기 위해 본 약관을 마련하였습니다. 본 약관은 회사가 제공하는 모든 서비스에 적용됩니다.</p>
          </div>
          ...
          <div className="pt-8 border-t space-y-4">
            ...
            <div className="pl-8 space-y-3">
              <p className="text-foreground/80 leading-relaxed">본 약관에 동의하시면 도깨비테니스의 서비스를 이용하실 수 있습니다. 약관에 동의하지 않으실 경우 서비스 이용이 제한될 수 있습니다.</p>
