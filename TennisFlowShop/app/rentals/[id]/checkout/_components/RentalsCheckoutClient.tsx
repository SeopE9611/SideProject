                    ...
                    {selectedString ? (
                      <div className="space-y-1">
                        ...
                        <div className="mt-2 text-xs text-muted-foreground">
                          * 대여 결제 시 입력한 교체 서비스 정보가 함께
                          접수됩니다. (구형/예외 건만 별도 신청서 이동)
                        </div>
                      </div>
                    ) : (
                      <div className="text-sm text-muted-foreground">
                        현재는 <b>교체 서비스 미선택</b> 상태입니다. 필요하면
                        "스트링 선택"을 눌러 교체 서비스를 함께 진행할 수
                        있습니다.
                      </div>
                    )}
                  </div>
                    ...
                    <Card className="bg-card/60 border border-border shadow-none">
                      <div className="bg-card p-4 border-b border-border">
                        ...
                        <CardDescription className="mt-1">
                          대여 checkout에서 바로 신청서 핵심 항목을 입력합니다.
                        </CardDescription>
                      </div>
                      <CardContent className="p-4">
                        <MountingInfoSection
                          ...
                          handleInputChange={
                            rentalStringingAdapter.handleInputChange
                          }
                          fromPDP={false}
                          orderId={null}
                          rentalId={initial.racketId}
                          ...
                          handleStringTypesChange={
                            rentalStringingAdapter.handleStringTypesChange
                          }
                          handleCustomInputChange={
                            rentalStringingAdapter.handleCustomInputChange
                          }
                          handleUseQtyChange={
                            rentalStringingAdapter.handleUseQtyChange
                          }
                          ...
                          handleLineFieldChange={
                            rentalStringingAdapter.handleLineFieldChange
                          }
                          ...
                          hasCacheForDate={
                            rentalStringingAdapter.hasCacheForDate
                          }
                          slotsError={rentalStringingAdapter.slotsError}
                          visitSlotCountUi={
                            rentalStringingAdapter.visitSlotCountUi
                          }
                          visitDurationMinutesUi={
                            rentalStringingAdapter.visitDurationMinutesUi
                          }
