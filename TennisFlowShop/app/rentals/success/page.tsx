...
async function getData(db: any, id: string, r: any) {
  ...
  const appId = (r as any)?.stringingApplicationId
    ? String((r as any).stringingApplicationId)
    : null;
  ...
  return {
    ...
    status: r.status,
    withStringService:
      Boolean((r as any)?.stringing?.requested) ||
      Boolean((r as any)?.isStringServiceApplied) ||
      Boolean((r as any)?.stringingApplicationId),
