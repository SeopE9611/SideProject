      ...
      <div className="relative overflow-hidden bg-muted/30 py-10 bp-sm:py-12 bp-md:py-24">
        ...
        <SiteContainer variant="wide" className="relative">
          <div className="text-center text-foreground">
            ...
            <p className="text-base bp-sm:text-lg bp-md:text-2xl mb-5 bp-sm:mb-6 bp-md:mb-8 text-muted-foreground max-w-3xl mx-auto leading-relaxed px-4">상호명 미정 스트링으로 플레이를 한 단계 업그레이드하세요</p>
          </div>
        </SiteContainer>
      </div>
