...
export default function ProductDetailRelatedProductsSection({
  ...
  return (
    <section ref={relatedSectionRef} className="mt-8 bp-md:mt-10" aria-labelledby="related-products-title">
      <h2 id="related-products-title" className="mb-4 break-keep text-ui-card-title-lg font-ui-bold leading-snug bp-sm:text-ui-section-title">
        관련 상품
      </h2>
          <HorizontalProducts
            title="관련 상품"
