        ...
        <div className="bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 dark:from-blue-950/20 dark:via-indigo-950/20 dark:to-purple-950/20 rounded-2xl p-8 border border-blue-100 dark:border-blue-800/30 shadow-lg">
          ...
          <div className="flex flex-col bp-md:flex-row bp-md:items-center bp-md:justify-between gap-4 bp-md:gap-6">
            ...
            <div className="flex items-center space-x-4 min-w-0 flex-1">
              <div className="bg-white dark:bg-gray-800 rounded-full p-3 shadow-md shrink-0">
                <ShoppingCart className="h-8 w-8 text-blue-600" />
              </div>
              <div className="min-w-0">
                <h1 className="text-2xl bp-sm:text-3xl font-bold text-gray-900 dark:text-gray-100">주문 상세정보</h1>
                <p className="text-gray-600 dark:text-gray-400 mt-1 break-all text-sm">주문번호: {orderId}</p>
              </div>
            </div>
            ...
            <div className="flex flex-col bp-md:flex-row gap-2 shrink-0">
              ...
              <Button variant={isEditMode ? 'destructive' : 'outline'} size="sm" onClick={() => setIsEditMode((m) => !m)} disabled={!canUserEdit} className={cn(isEditMode ? '' : 'bg-white/60 backdrop-blur-sm border-blue-200 hover:bg-blue-50')}>
          ...
          <div className="mb-4 flex flex-col gap-3 bp-sm:flex-row bp-sm:items-center bp-sm:justify-between rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
            ...
            {canWithdrawCancelRequest && (
              <Button
                ...
                className="w-full bp-sm:w-auto bp-sm:ml-4 border-amber-300 bg-white/70 text-amber-800 hover:bg-amber-100 hover:text-amber-900"
              >
