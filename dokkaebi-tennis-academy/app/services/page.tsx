    ...
    <div className="flex flex-col gap-16 py-8">
      ...
      <section className="container" id="string-types">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-[#64748b] dark:text-[#94a3b8]">
            플레이 스타일과 경기력 향상을 위한 다양한 특성의 스트링을 제공합니다. 자신에게 맞는 최적의 스트링을
            선택해보세요.
          </p>
        </div>
                ...
                <div>
                  ...
                  <ul className="space-y-1">
                    {type.recommended.map((rec, index) => (
                      <li key={index} className="flex items-start">
                        <svg
                          className="mr-2 h-4 w-4 shrink-0 text-[#3b82f6]"
      ...
      <section className="bg-[#f8fafc] py-16 dark:bg-[#0f172a]/60" id="pricing">
        <div className="container">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-2xl text-[#64748b] dark:text-[#94a3b8]">
              합리적인 가격으로 최고의 스트링 장착 서비스를 제공합니다. 다양한 옵션 중 필요한 서비스를 선택하세요.
            </p>
          </div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#64748b] dark:text-[#94a3b8]">
                    도깨비 테니스 아카데미 회원은 모든 스트링 장착 서비스 10% 할인
                  </p>
                </div>
              </li>
              <li className="flex items-start">
              ...
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#64748b] dark:text-[#94a3b8]">
                    3개 이상 라켓 동시 장착 시 라켓당 2,000원 할인
                  </p>
                </div>
              </li>
            </ul>
      ...
      <section className="container">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-[#64748b] dark:text-[#94a3b8]">
            도깨비 테니스 아카데미는 세심한 과정을 통해 최고 품질의 스트링 장착 서비스를 제공합니다.
          </p>
        </div>

        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="flex flex-col items-center text-center">
            <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-[#3b82f6] text-2xl font-bold text-white">
              1
            </div>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-[#64748b] dark:text-[#94a3b8]">
              장착 후 텐션과 패턴을 확인하고 완벽한 상태로 마무리합니다.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="mx-auto max-w-3xl rounded-xl bg-[#ffffff] p-8 text-center shadow-lg dark:bg-[#0f172a]">
            ...
            <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2">
              <div className="rounded-lg border p-6">
                ...
                <p className="mt-2 text-sm text-[#64748b] dark:text-[#94a3b8]">
                  운영 시간: 평일 09:00 - 18:00, 토요일 09:00 - 12:00
                </p>
              </div>
              ...
              <div className="rounded-lg border p-6">
                ...
                <h3 className="mb-2 text-xl font-bold">온라인 문의</h3>
                <p className="mb-4 text-[#64748b] dark:text-[#94a3b8]">문의 게시판을 통해 예약 요청을 남겨주세요.</p>
            ...
            <div className="mt-6 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <Button
                variant="outline"
                className="border-[#3b82f6] text-[#3b82f6] hover:bg-[#3b82f6] hover:text-[#ffffff]"
                asChild
              >
                <Link href="/board/qna">
      ...
      <section className="container pb-16">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-[#64748b] dark:text-[#94a3b8]">
            도깨비 테니스 아카데미 스트링 서비스를 경험한 고객들의 생생한 후기입니다.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          <Card>
            <CardContent className="p-6">
              ...
              <p className="mb-4">
                "프로 수준의 정확한 장력과 세심한 작업으로 스트링 장착해주셔서 경기력이 크게 향상되었습니다. 특히 스핀이
                잘 걸리는 스트링 추천에 매우 만족합니다."
              </p>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <p className="mb-4">
                "테니스를 시작한 지 얼마 안 된 초보자였는데, 친절하게 스트링과 장력에 대해 상세히 설명해주셨어요. 덕분에
                테니스에 더 재미를 붙이게 되었습니다!"
              </p>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <p className="mb-4">
                "하이브리드 조합을 추천받아 사용해봤는데, 정말 제 플레이 스타일에 딱 맞았습니다. 장착 후 실력이 눈에
                띄게 향상되어 대회에서도 좋은 성적을 거둘 수 있었습니다. 다음에도 꼭 이용하겠습니다."
              </p>
