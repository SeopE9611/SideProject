...
export default function StringServiceApplyPage() {
  ...
  if (shouldShowEntryChooser)
    return (
      <div className="min-h-full bg-card dark:bg-card bp-lg:bg-background bp-lg:from-slate-50 bp-lg:via-blue-50 bp-lg: bp-lg:dark:from-slate-900 bp-lg:dark:via-slate-800 bp-lg:dark:to-slate-900">
        {/* Hero Section */}
        <ApplyHero />
            ...
            <div className="relative bg-card dark:bg-card rounded-2xl p-5 bp-sm:p-6 text-left border border-border dark:border-border hover:border-border dark:hover:border-border transition-all duration-200 hover:shadow-lg hover:shadow-slate-200/50 dark:hover:shadow-slate-900/50">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 px-3 py-2 bp-sm:py-2.5 text-sm font-medium rounded-lg bg-background dark:bg-card text-foreground dark:text-muted-foreground hover:bg-muted dark:hover:bg-card transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-900 dark:focus-visible:ring-slate-100"
                >
                  라켓 구매
                </button>
                <button
          ...
          <div className="mt-6 bp-sm:mt-8 max-w-5xl mx-auto">
            <div className="flex items-start gap-3 p-4 rounded-xl bg-background dark:bg-card border border-border dark:border-border">
              ...
              <p className="text-sm text-muted-foreground dark:text-muted-foreground leading-relaxed">
                결제(주문) 이후 신청으로 진행하면 <span className="font-medium text-foreground dark:text-muted-foreground">금액·결제정보가 자동 반영</span>되어 실수 가능성이 줄어들어요.
              </p>
            </div>
          </div>
              ...
              <div className="flex flex-col bp-sm:flex-row bp-sm:items-center bp-sm:justify-between gap-4">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 bp-sm:flex-none px-4 py-2.5 text-sm font-medium rounded-lg border border-border dark:border-border text-foreground dark:text-muted-foreground hover:bg-background dark:hover:bg-card transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-900 dark:focus-visible:ring-slate-100"
                  >
                    주문 내역
                  </button>
                  <button
