  ...
  return (
    <>
      ...
      <div className="min-h-full bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
        <div className="relative overflow-hidden bg-gradient-to-r from-emerald-600 via-green-600 to-teal-600 py-20">
          ...
          <div className="relative container mx-auto px-4 text-center text-white">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-white to-emerald-200 bg-clip-text text-transparent">신청이 완료되었습니다!</h1>
            <p className="text-xl md:text-2xl text-emerald-100 max-w-3xl mx-auto leading-relaxed">도깨비 테니스 아카데미에서 확인 후 빠르게 연락드리겠습니다</p>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-5xl mx-auto">
            <Card className="mb-8 backdrop-blur-sm bg-white/90 dark:bg-slate-800/90 border-0 shadow-2xl">
              <CardHeader className="bg-gradient-to-r from-emerald-50 to-green-50 dark:from-slate-700 dark:to-slate-600 rounded-t-lg">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription className="text-lg mt-2">
                      신청 번호: <span className="font-mono font-semibold text-emerald-600">{application._id.toString()}</span>
                    </CardDescription>
                  </div>
              ...
              <CardContent className="p-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  <div className="bg-gradient-to-br from-emerald-50 to-green-50 dark:from-slate-700 dark:to-slate-600 p-6 rounded-xl">
                    <div className="flex items-center mb-3">
                      <Calendar className="h-6 w-6 text-emerald-600 mr-3" />
                      <h3 className="font-semibold text-gray-900 dark:text-white">신청일자</h3>
                    </div>
                    <p className="text-2xl font-bold text-emerald-600">{new Date(application.createdAt).toLocaleDateString('ko-KR')}</p>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-teal-50 to-emerald-50 dark:from-slate-700 dark:to-slate-600 p-6 rounded-xl">
                    <div className="flex items-center mb-3">
                      <Clock className="h-6 w-6 text-teal-600 mr-3" />
                      <h3 className="font-semibold text-gray-900 dark:text-white">희망일</h3>
                    </div>
                    <p className="text-lg font-bold text-teal-600">{application.stringDetails.preferredDate}</p>
                    {application.stringDetails.preferredTime && <p className="text-sm text-teal-500 mt-1">{application.stringDetails.preferredTime}</p>}
                  </div>
                </div>
                ...
                {application.shippingInfo?.bank && (
                  <div className="mb-8">
                    ...
                    <div className="bg-gradient-to-r from-emerald-50 via-green-50 to-teal-50 dark:from-slate-700 dark:to-slate-600 rounded-xl p-6 border-2 border-emerald-200 dark:border-slate-500">
                ...
                <div className="space-y-6">
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white flex items-center">
                    <Racquet className="h-6 w-6 mr-3 text-teal-600" />
                    장착 정보
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="p-6 bg-gradient-to-br from-teal-50 to-emerald-50 dark:from-slate-700 dark:to-slate-600 rounded-xl">
                      <div className="flex items-center mb-3">
                        <Racquet className="h-5 w-5 text-teal-600 mr-2" />
                    ...
                    <div className="p-6 bg-gradient-to-br from-emerald-50 to-green-50 dark:from-slate-700 dark:to-slate-600 rounded-xl">
                      <div className="flex items-center mb-3">
                  ...
                  {application.stringDetails.requirements && (
                    <div className="p-6 bg-gradient-to-br from-green-50 to-teal-50 dark:from-slate-700 dark:to-slate-600 rounded-xl">
              ...
              <CardFooter className="bg-gray-50 dark:bg-slate-700 rounded-b-lg p-8">
                <div className="flex flex-col sm:flex-row gap-4 w-full">
                  <Button className="flex-1 h-12 bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white transition-all duration-200" asChild>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <Card className="backdrop-blur-sm bg-white/90 dark:bg-slate-800/90 border-0 shadow-xl">
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center p-3 bg-emerald-50 dark:bg-slate-700 rounded-lg">
                    ...
                    <div className="flex items-center p-3 bg-teal-50 dark:bg-slate-700 rounded-lg">
