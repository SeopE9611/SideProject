        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <div className="mb-1 text-sm text-gray-500 dark:text-gray-400">
              ...
              <Link href="/board/gear" onClick={onLeaveLinkClick} className="text-gray-500 underline-offset-2 hover:underline dark:text-gray-300">
                장비 사용기 게시판
              </Link>
              <span className="mx-1">›</span>
              <span>글 수정</span>
        ...
        <Card className="border-0 bg-white/90 shadow-xl backdrop-blur-sm dark:bg-gray-900/80">
          ...
          <CardContent className="p-6">
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              {/* 하단 버튼 */}
              <div className="flex justify-end gap-2">
                <Button type="button" variant="outline" size="sm" className={cn('gap-2')} disabled={isSubmitting || isUploadingImages || isUploadingFiles} onClick={() => confirmLeaveIfDirty(() => router.push(`/board/gear/${id}`))}>
                  <ArrowLeft className="h-4 w-4" />
                  <span>취소</span>
                </Button>
