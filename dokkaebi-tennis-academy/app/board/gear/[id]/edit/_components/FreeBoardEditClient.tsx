        ...
        <Card className="border-0 bg-white/90 shadow-xl backdrop-blur-sm dark:bg-gray-900/80">
          ...
          <CardContent className="p-6">
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              {/* 하단 버튼 */}
              <div className="flex justify-end gap-2">
                <Button type="button" variant="outline" size="sm" className={cn('gap-2')} disabled={isSubmitting || isUploadingImages || isUploadingFiles} onClick={() => router.push(`/board/gear/${id}`)}>
                  <ArrowLeft className="h-4 w-4" />
                  <span>취소</span>
                </Button>
