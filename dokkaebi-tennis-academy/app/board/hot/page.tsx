      ...
      <div className="container mx-auto px-4 py-8 space-y-8">
        ...
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-gray-900 dark:text-white">인기글 모아보기 (준비중)</h1>
            <p className="mt-1 text-sm md:text-base text-gray-600 dark:text-gray-300">조회수, 댓글 수, 공감 수 등을 기준으로 인기 게시글을 큐레이션하는 페이지입니다. 현재 기능을 준비하고 있습니다.</p>
          </div>
        ...
        <Card className="border-0 bg-white/80 dark:bg-gray-800/80 shadow-xl backdrop-blur-sm">
          ...
          <CardContent className="p-6 space-y-3 text-sm md:text-base text-gray-600 dark:text-gray-300">
            ...
            <p className="pt-2 text-xs md:text-sm text-gray-500 dark:text-gray-400">기능 오픈 전까지는 리뷰 게시판에서 인기 있는 후기들을 먼저 확인해 보실 수 있습니다.</p>
