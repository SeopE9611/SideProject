      ...
      <SiteContainer variant="wide" className="py-6 bp-sm:py-8 bp-md:py-10 space-y-8">
        ...
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-gray-900 dark:text-white">브랜드별 게시판 (준비중)</h1>
            <p className="mt-1 text-sm md:text-base text-gray-600 dark:text-gray-300">윌슨, 바볼랏, 요넥스 등 브랜드별로 라켓/스트링 사용 후기를 모아볼 수 있는 공간입니다. 현재 기능을 준비하고 있습니다.</p>
          </div>
        ...
        <Card className="border-0 bg-white/80 dark:bg-gray-800/80 shadow-xl backdrop-blur-sm">
          ...
          <CardContent className="p-6 space-y-3 text-sm md:text-base text-gray-600 dark:text-gray-300">
            ...
            <p className="pt-2 text-xs md:text-sm text-gray-500 dark:text-gray-400">현재는 상품 상세 페이지와 리뷰 게시판에서 브랜드 후기를 먼저 확인해 보실 수 있습니다.</p>
