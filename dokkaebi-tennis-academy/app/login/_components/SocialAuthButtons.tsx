...
export default function SocialAuthButtons({ onKakaoClick, onNaverClick, onGoogleClick, isRegisterMode = false }: Props) {
  return (
    <div className="space-y-3">
      {/* 카카오 로그인 */}
      <Button type="button" onClick={onKakaoClick} className="w-full h-12 bg-[#FEE500] hover:bg-[#FDD835] text-[#000000] font-semibold text-[15px] flex items-center justify-center gap-3 transition-all duration-200 shadow-sm hover:shadow-md">
      ...
      <Button
        ...
        disabled={!onNaverClick}
        className="w-full h-12 bg-[#03C75A] hover:bg-[#02B350] text-white font-semibold text-[15px] flex items-center justify-center gap-3 transition-all duration-200 shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
      >
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M13.6202 10.7393L6.91699 2H3V18H6.37983V9.26071L13.083 18H17V2H13.6202V10.7393Z" fill="white" />
        </svg>
      ...
      <Button
        ...
        className="w-full h-12 bg-card hover:bg-muted dark:bg-muted dark:hover:bg-muted text-foreground font-semibold text-[15px] flex items-center justify-center gap-3 border border-border dark:border-border transition-all duration-200 shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
      >
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
