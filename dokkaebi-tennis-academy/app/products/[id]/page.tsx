...
export default async function ProductDetailPage({ params }: { params: { id: string } }) {
  ...
  //   name: '루키론 프로 스트링',
  //   price: 25000,
  //   images: ['/placeholder.svg?height=400&width=400', '/placeholder.svg?height=400&width=400', '/placeholder.svg?height=400&width=400', '/placeholder.svg?height=400&width=400'],
  //   brand: '루키론',
  //   features: {
  //     반발력: 4,
  //     내구성: 5,
  //     스핀: 3,
  //   },
  //   description: '루키론 프로 스트링은 프로 선수들이 선호하는 고성능 스트링입니다. 뛰어난 내구성과 우수한 반발력으로 파워풀한 샷을 구사할 수 있습니다. 특히 하드 히터들에게 적합한 스트링으로, 강한 임팩트에도 안정적인 성능을 발휘합니다.',
  //   specifications: {
  //     재질: '폴리에스터',
  //     게이지: '1.25mm / 16G',
  //     색상: '블랙',
