...
export default function ProductDetailClient({ product }: { product: any }) {
 ...
 return (
 <div className="min-h-full bg-gradient-to-br from-background to-muted pb-20 bp-md:pb-8">
 {/* Hero Section with Breadcrumb */}
 <div className="relative bg-gradient-to-r from-accent to-primary text-white py-6 sm:py-8">
 ...
 <Card className="overflow-hidden border-0 shadow-xl sm:shadow-2xl bg-card/90 backdrop-blur-sm ">
 ...
 <Badge className="bg-gradient-to-r from-accent to-primary text-white text-xs">정품</Badge>
 </div>
 </div>
 </Card>
 ...
 <Card className="border-0 shadow-lg sm:shadow-xl bg-card/90 backdrop-blur-sm ">
 <CardContent className="p-4 sm:p-6">
 <div className="space-y-3 sm:space-y-4">
 {/* 브랜드와 제품명 */}
 <div>
 <Badge variant="outline" className="mb-2 text-xs text-accent border-border ">
 ...
 {[...Array(5)].map((_, i) => (
 <Star key={i} className={`h-3 w-3 sm:h-4 sm:w-4 ${i < Math.floor(averageRating) ? 'fill-yellow-400 text-yellow-400' : 'fill-gray-200 text-muted-foreground'}`} />
 ))}
 </div>
 ...
 <span className="inline-flex items-center rounded-md bg-secondary border border-border px-2 py-1 text-xs">
 ...
 <div className="flex items-center gap-2 p-2.5 sm:p-3 bg-destructive/10 border border-border rounded-lg">
 <Clock className="h-4 w-4 text-destructive shrink-0" />
 <span className="text-xs sm:text-sm text-destructive">현재 남은 수량이 {product.inventory.stock}개입니다.</span>
 </div>
 )}

 <div id="cta-anchor" className="flex flex-col gap-2 sm:gap-3">
 {product.inventory?.manageStock && product.inventory.stock <= 0 ? (
 <Button disabled className="w-full h-10 sm:h-11 text-sm bg-destructive/10 text-destructive border border-border  ">
 ...
 <>
 <Button
 className="w-full h-10 sm:h-11 text-sm bg-gradient-to-r from-accent to-primary text-white shadow hover:from-accent/90 hover:to-primary/90"
 ...
 <Button
 className="flex-1 h-12 rounded-lg border border-border bg-card  hover:bg-muted hover:bg-secondary active:bg-muted active:bg-muted text-foreground font-semibold text-sm transition-colors flex items-center justify-center gap-2"
 ...
 className={`w-full h-10 sm:h-11 text-sm ${isWishlisted ? 'bg-destructive/10 border-border text-destructive  ' : ''}`}
 >
 ...
 <div>
 <h4 className="font-medium text-xs sm:text-sm text-foreground mb-2 sm:mb-3">추천 대상</h4>
 <div className="space-y-1.5 sm:space-y-2">
 {selectedPlayerTypes.length > 0 && (
 <div className="flex items-center gap-2 text-xs sm:text-sm">
 <div className="w-2 h-2 bg-secondary0 rounded-full shrink-0"></div>
 ...
 <div>
 <h4 className="font-medium text-xs sm:text-sm text-foreground mb-2 sm:mb-3">추가 특성</h4>
 ...
 <div key={index} className="p-2.5 sm:p-3 bg-secondary rounded-lg">
 <div className="flex items-center gap-1.5 sm:gap-2 mb-1.5 sm:mb-2">
 <spec.icon className="h-3 w-3 sm:h-4 sm:w-4 text-accent " />
 <span className="text-xs sm:text-sm font-medium text-foreground ">{spec.name}</span>
 </div>
 <div className="flex gap-1">
 {[...Array(5)].map((_, i) => (
 <div key={i} className={`w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full ${i < featureValue(spec.key, spec.koKey) ? 'bg-secondary0 ' : 'bg-border '}`} />
 ))}
 </div>
 </div>
 ))}
 ...
 <Card className="mt-8 sm:mt-12 border-0 shadow-lg sm:shadow-xl bg-card/90 backdrop-blur-sm ">
 <CardContent className="p-0">
 <Tabs value={activeTab} onValueChange={(v) => updateTabInUrl(v as any)} className="w-full">
 <TabsList className="w-full grid grid-cols-2 md:grid-cols-4 h-auto gap-0.5 sm:gap-1 bg-gradient-to-r from-secondary to-muted  dark:via-indigo-900/20 dark:to-purple-900/20 rounded-t-lg p-0.5 sm:p-1">
 <TabsTrigger
 value="description"
 className="min-w-0 h-11 sm:h-12 md:h-16 px-2 text-xs sm:text-sm md:text-base font-medium truncate data-[state=active]:bg-card data-[state=active]:shadow-md data-[state=active]:text-accent dark:data-[state=active]:bg-card dark:data-[state=active]:text-accent"
 >
 ...
 <div className="bg-gradient-to-r from-blue-50 to-muted   p-4 sm:p-6 rounded-lg">
 ...
 .filter(([, value]) => value)
 .map(([key, value]) => (
 <div key={key} className="bg-gradient-to-r from-blue-50 to-muted   p-3 sm:p-4 rounded-lg border border-blue-100 ">
 <div className="flex items-center justify-between">
 <span className="font-semibold text-accent text-sm sm:text-base">{key}</span>
 <span className="text-foreground font-medium text-sm sm:text-base">{String(value)}</span>
 </div>
 </div>
 ))}
 </div>
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
 {/* 메인 */}
 <div className="bg-gradient-to-r from-blue-50 to-muted   p-3 sm:p-4 rounded-lg border border-blue-100 ">
 ...
 <Button asChild className="bg-gradient-to-r from-accent to-primary hover:from-accent/90 hover:to-primary/90 text-white shadow-lg text-xs sm:text-sm h-9 sm:h-10">
 ...
 <div className="absolute inset-0 bg-card/70 bg-background/40 backdrop-blur-sm flex items-center justify-center z-10 rounded-lg">
 ...
 <div className="w-10 h-10 bg-gradient-to-r from-accent to-primary rounded-full flex items-center justify-center text-white font-bold text-lg shadow-lg">{review.user?.charAt(0) || 'U'}</div>
 <div>
 ...
 {[...Array(5)].map((_, i) => (
 <Star key={i} className={`h-3 w-3 sm:h-4 sm:w-4 ${i < (review.rating || 5) ? 'fill-yellow-400 text-yellow-400' : 'fill-gray-200 text-muted-foreground'}`} />
 ))}
 </div>
 ...
 return (
 <div className="space-y-3 sm:space-y-4">
 <div className="bg-card /50 p-3 sm:p-4 rounded-lg border border-blue-100 ">
 <p className="text-foreground leading-relaxed text-sm sm:text-base">{review.content}</p>
 </div>
 ...
 className="relative w-16 h-16 sm:w-20 sm:h-20 rounded-lg overflow-hidden border-2 border-border hover:border-blue-400 dark:hover:border-blue-500 transition-colors shadow-md shrink-0"
 ...
 <div className="w-16 sm:w-20 h-16 sm:h-20 bg-gradient-to-r from-secondary to-muted   rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 shadow-lg">
 ...
 <Button className="bg-gradient-to-r from-accent to-primary hover:from-accent/90 hover:to-primary/90 text-white shadow-lg px-6 sm:px-8 py-2 sm:py-3 text-sm sm:text-base">
 ...
 <Button asChild className="bg-gradient-to-r from-accent to-primary hover:from-accent/90 hover:to-primary/90 text-white shadow-lg px-6 sm:px-8 py-2 sm:py-3 text-sm sm:text-base">
 <Link href={`/board/qna/write?productId=${product._id}&productName=${encodeURIComponent(product.name)}`}>문의하기</Link>
 </Button>
 </div>
 ) : (
 ...
 {q.isSecret && (
 <Badge variant="outline" className={`${badgeBaseOutlined} ${badgeSizeSm} bg-muted text-foreground border-border /40 shrink-0`}>
 ...
 <div key={i} className="rounded-xl p-3 sm:p-4 bg-card/80 /80 shadow-sm animate-pulse">
 ...
 <div
 key={`rel-ph-${i}`}
 className="rounded-xl p-3 sm:p-4 border-2 border-dashed border-border/70 /70
 ...
 {/* 수량 조절 */}
 <div className="flex items-center gap-0 rounded-lg border border-border bg-muted /50">
 <button
 type="button"
 className="h-9 w-9 flex items-center justify-center text-muted-foreground disabled:opacity-30 disabled:cursor-not-allowed active:bg-muted dark:active:bg-secondary transition-colors"
 aria-label="수량 감소"
 disabled={!canDec}
 ...
 onClick={handleBuyNow}
 disabled={loading || stock <= 0 || quantity > stock}
 className="flex-1 h-12 rounded-lg bg-blue-600 hover:bg-blue-700 active:bg-blue-800 disabled:bg-border dark:disabled:bg-secondary text-white font-semibold text-sm transition-colors shadow-sm disabled:cursor-not-allowed flex items-center justify-center gap-2"
 >
