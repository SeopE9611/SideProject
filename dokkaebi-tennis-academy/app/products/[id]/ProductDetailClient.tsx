  ...
  return (
    <div className="min-h-full bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/20 dark:from-slate-950 dark:via-slate-900 dark:to-slate-800 pb-20 bp-md:pb-8">
      ...
      <div className="relative bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white py-6 sm:py-8">
        ...
        <SiteContainer variant="wide" className="relative">
          <div className="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm mb-3 sm:mb-4 opacity-90 overflow-x-auto scrollbar-hide">
            ...
            <span>/</span>
            <Link href="/products" className="hover:text-blue-200 transition-colors whitespace-nowrap">
              상품
            </Link>
            <span>/</span>
            <span className="text-blue-200 truncate max-w-[120px] sm:max-w-none">{product.name}</span>
          </div>
          <Button variant="ghost" className="text-white hover:bg-white/10 p-0 h-auto text-sm" onClick={() => router.back()}>
      ...
      <SiteContainer variant="wide" className="py-4 bp-sm:py-6 bp-md:py-8">
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-baseline gap-2 sm:gap-3 flex-wrap">
                      <span className="text-2xl sm:text-3xl font-bold text-blue-600 dark:text-blue-400">{product.price.toLocaleString()}원</span>
                  ...
                  <div className="pt-3 sm:pt-4 border-t">
                    <h3 className="font-semibold text-sm sm:text-base mb-2 sm:mb-3 flex items-center">
                      <Truck className="mr-2 h-4 w-4 sm:h-5 sm:w-5 text-blue-600 dark:text-blue-400" />
                      배송 정보
                    </h3>
                ...
                {[
                  ...
                  <div key={index} className="p-2.5 sm:p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                    <div className="flex items-center gap-1.5 sm:gap-2 mb-1.5 sm:mb-2">
                      <spec.icon className="h-3 w-3 sm:h-4 sm:w-4 text-blue-600 dark:text-blue-400" />
        ...
        <Card className="mt-8 sm:mt-12 border-0 shadow-lg sm:shadow-xl bg-white/90 backdrop-blur-sm dark:bg-slate-800/90">
          <CardContent className="p-0">
            <Tabs value={activeTab} onValueChange={(v) => updateTabInUrl(v as any)} className="w-full">
              <TabsList className="w-full grid grid-cols-2 md:grid-cols-4 h-auto gap-0.5 sm:gap-1 bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 dark:from-blue-900/20 dark:via-indigo-900/20 dark:to-purple-900/20 rounded-t-lg p-0.5 sm:p-1">
                <TabsTrigger
                  value="description"
                  className="min-w-0 h-11 sm:h-12 md:h-16 px-2 text-xs sm:text-sm md:text-base font-medium truncate data-[state=active]:bg-white data-[state=active]:shadow-md data-[state=active]:text-blue-700 dark:data-[state=active]:bg-slate-800 dark:data-[state=active]:text-blue-400"
                >
                    ...
                    {Object.entries(toDisplaySpec())
                      ...
                      .map(([key, value]) => (
                        <div key={key} className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-3 sm:p-4 rounded-lg border border-blue-100 dark:border-blue-800">
                          <div className="flex items-center justify-between">
                            <span className="font-semibold text-blue-700 dark:text-blue-400 text-sm sm:text-base">{key}</span>
                    ...
                    {mergedReviews.length > 0 ? (
                        ...
                        <Card key={index} className="border-0 shadow-lg bg-gradient-to-r from-white to-blue-50/30 dark:from-slate-800 dark:to-blue-900/10">
                          <CardContent className="p-4 sm:p-6 relative">
                            ...
                            {(() => {
                              ...
                              return (
                                <div className="space-y-3 sm:space-y-4">
                                  <div className="bg-white dark:bg-slate-700/50 p-3 sm:p-4 rounded-lg border border-blue-100 dark:border-blue-800">
                      ...
                      <div className="text-center py-8 sm:py-16">
                        <div className="w-16 sm:w-20 h-16 sm:h-20 bg-gradient-to-r from-blue-100 to-indigo-100 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 shadow-lg">
                          <Star className="h-8 w-8 sm:h-10 sm:w-10 text-blue-500 dark:text-blue-400" />
                        </div>
                ...
                {!qnaLoading && !qnaError && (
                  <>
                    {qnas.length === 0 ? (
                      <div className="text-center py-8 sm:py-16">
                        <div className="w-16 sm:w-20 h-16 sm:h-20 bg-gradient-to-r from-blue-100 to-indigo-100 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 shadow-lg">
                          <MessageSquare className="h-8 w-8 sm:h-10 sm:w-10 text-blue-500 dark:text-blue-400" />
                        </div>
                                ...
                                <div className="flex items-start justify-between">
                                  <div className="flex-1 min-w-0">
                                    <div className="space-y-1 min-w-0">
                                      ...
                                      <div className="font-semibold text-gray-900 dark:text-white truncate hover:text-blue-600 dark:hover:text-blue-400 text-sm sm:text-base">{q.title}</div>
              ...
              {loadingRelated ? (
                ...
                <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4">
                  {Array.from({ length: 4 }).map((_, i) => (
                    <div key={i} className="rounded-xl p-3 sm:p-4 bg-white/80 dark:bg-slate-800/80 shadow-sm animate-pulse">
                    ...
                    <Link key={rp._id} href={`/products/${rp._id}`}>
                      <Card className="h-full overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 group border border-slate-200 dark:border-slate-700">
                        ...
                        <CardContent className="p-3 sm:p-4">
                          ...
                          <div className="font-medium line-clamp-2 mb-1.5 sm:mb-2 text-sm sm:text-base group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">{rp.name}</div>
                          <div className="font-bold text-blue-600 dark:text-blue-400 text-sm sm:text-base">{Number(rp.price).toLocaleString()}원</div>
                        </CardContent>
                      </Card>
                    </Link>
                  ))}
