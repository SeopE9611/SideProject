...
export const th =
  'sticky top-0 z-10 whitespace-nowrap px-3.5 py-2 bg-background dark:bg-card shadow-sm border-b border-border text-[12px] font-semibold text-foreground text-center';
