...
function NumberSkeleton() {
  return <span className="inline-block h-7 w-12 rounded bg-gray-200 dark:bg-gray-700 animate-pulse align-middle" />;
}
...
export default function ProductsLoading() {
  ...
  return (
    <div className="min-h-full flex flex-col p-6 space-y-8">
      ...
      <section className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4 mb-8 shrink-0">
        <Card className="border-0 bg-white/80 dark:bg-gray-800/80 shadow-lg backdrop-blur-sm">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">전체 상품</p>
        ...
        <Card className="border-0 bg-white/80 dark:bg-gray-800/80 shadow-lg backdrop-blur-sm">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">판매 중</p>
                <p className="text-3xl font-bold text-gray-900 dark:text-gray-100">
                  <NumberSkeleton />
                </p>
              </div>
      ...
      <Card className="border-0 bg-white/80 dark:bg-gray-800/80 shadow-lg backdrop-blur-sm flex-1 min-h-0 flex flex-col">
        <CardHeader className="pb-4 shrink-0">
          <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
            <div>
              <CardTitle className="text-xl font-semibold text-gray-900 dark:text-gray-100">스트링 목록</CardTitle>
              <CardDescription className="text-gray-600 dark:text-gray-400">목록을 불러오는 중…</CardDescription>
            </div>
        ...
        <CardContent className="space-y-6 flex-1 min-h-0 flex flex-col">
          ...
          <div className="w-full max-w-md">
            <div className="relative">
              ...
              <div className="pl-8 h-9 text-xs rounded-md bg-gray-100 dark:bg-gray-700" />
          ...
          <div className="overflow-hidden rounded-lg border border-gray-200 dark:border-gray-700">
            <Table className="table-fixed">
              <TableHeader className="bg-white/60 dark:bg-gray-800/60 sticky top-0 z-10">
                <TableRow>
                ...
                {Array.from({ length: PAGE_SIZE }).map((_, i) => (
                  <TableRow key={i}>
                    <TableCell colSpan={8} className="p-0">
                      <div className="h-14 animate-pulse bg-gray-50 dark:bg-gray-800" />
                    </TableCell>
                  </TableRow>
                ))}
              </TableBody>
