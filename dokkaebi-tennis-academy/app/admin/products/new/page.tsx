...
export default function NewStringPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    // 실제로는 API 호출을 통해 상품을 저장합니다
    console.log("스트링 저장 로직 실행")
    // 저장 후 상품 목록 페이지로 이동
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input id="string-name" placeholder="스트링명을 입력하세요" required />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="string-sku">SKU (재고 관리 코드)</Label>
                  <Input id="string-sku" placeholder="예: STR-LUX-001" />
                </div>
              </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex">
                    <Input id="string-regular-price" type="number" min="0" step="1000" placeholder="0" required />
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">{powerRating}/5</span>
                </div>
                <Slider id="power-rating" min={1} max={5} step={1} value={powerRating} onValueChange={setPowerRating} />
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">{controlRating}/5</span>
                </div>
                <Slider
                  id="control-rating"
                  min={1}
                  ...
                  step={1}
                  value={controlRating}
                  onValueChange={setControlRating}
                />
                <div className="flex justify-between text-xs text-muted-foreground">
                  <span>낮음</span>
                  <span>높음</span>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">{spinRating}/5</span>
                </div>
                <Slider id="spin-rating" min={1} max={5} step={1} value={spinRating} onValueChange={setSpinRating} />
                <div className="flex justify-between text-xs text-muted-foreground">
                  <span>낮음</span>
                  <span>높음</span>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">{durabilityRating}/5</span>
                </div>
                <Slider
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">{comfortRating}/5</span>
                </div>
                <Slider
                  id="comfort-rating"
                  min={1}
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  재고 관리를 사용하면 판매될 때마다 재고가 자동으로 감소합니다.
                </p>
              </div>
        ...
        <TabsContent value="images" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                스트링의 이미지를 추가하세요. 첫 번째 이미지가 대표 이미지로 사용됩니다.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
