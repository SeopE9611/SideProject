                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      {siteForm.formState.errors.siteName && (
                        <p className="text-sm text-red-500">{siteForm.formState.errors.siteName.message}</p>
                      )}
                    </div>
                    <div className="space-y-2">
                      ...
                      {siteForm.formState.errors.contactEmail && (
                        <p className="text-sm text-red-500">{siteForm.formState.errors.contactEmail.message}</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    {siteForm.formState.errors.siteDescription && (
                      <p className="text-sm text-red-500">{siteForm.formState.errors.siteDescription.message}</p>
                    )}
                  </div>
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      {siteForm.formState.errors.contactPhone && (
                        <p className="text-sm text-red-500">{siteForm.formState.errors.contactPhone.message}</p>
                      )}
                    </div>
                    <div className="space-y-2">
                      ...
                      {siteForm.formState.errors.address && (
                        <p className="text-sm text-red-500">{siteForm.formState.errors.address.message}</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      {siteForm.formState.errors.logoUrl && (
                        <p className="text-sm text-red-500">{siteForm.formState.errors.logoUrl.message}</p>
                      )}
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="faviconUrl">파비콘 URL</Label>
                      <Input id="faviconUrl" {...siteForm.register("faviconUrl")} />
                      {siteForm.formState.errors.faviconUrl && (
                        <p className="text-sm text-red-500">{siteForm.formState.errors.faviconUrl.message}</p>
                      )}
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => userForm.setValue("defaultUserRole", value)}
                    >
              ...
              <form onSubmit={emailForm.handleSubmit(onSubmitEmailSettings)}>
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      {emailForm.formState.errors.smtpHost && (
                        <p className="text-sm text-red-500">{emailForm.formState.errors.smtpHost.message}</p>
                      )}
                    </div>
                    <div className="space-y-2">
                      ...
                      {emailForm.formState.errors.smtpPort && (
                        <p className="text-sm text-red-500">{emailForm.formState.errors.smtpPort.message}</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      {emailForm.formState.errors.smtpUsername && (
                        <p className="text-sm text-red-500">{emailForm.formState.errors.smtpUsername.message}</p>
                      )}
                    </div>
                    <div className="space-y-2">
                      ...
                      {emailForm.formState.errors.smtpPassword && (
                        <p className="text-sm text-red-500">{emailForm.formState.errors.smtpPassword.message}</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      value={emailForm.watch("smtpEncryption")}
                      onValueChange={(value) => emailForm.setValue("smtpEncryption", value)}
                    >
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      {emailForm.formState.errors.senderName && (
                        <p className="text-sm text-red-500">{emailForm.formState.errors.senderName.message}</p>
                      )}
                    </div>
                    <div className="space-y-2">
                      ...
                      {emailForm.formState.errors.senderEmail && (
                        <p className="text-sm text-red-500">{emailForm.formState.errors.senderEmail.message}</p>
                      )}
                    </div>
                  </div>
                </CardContent>
