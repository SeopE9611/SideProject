    ...
    <div className="container py-10">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-8">
          ...
          <Skeleton className="mt-2 h-5 w-96 rounded bg-gray-100" />
        </div>
        ...
        <Card className="mb-8 border border-muted bg-muted/30 shadow-sm">
          <CardHeader className="pb-3">
            ...
            <Skeleton className="h-4 w-80 mt-2 rounded bg-gray-100" />
          </CardHeader>
          <CardContent>
            <div className="flex flex-col gap-4 md:flex-row">
              <Skeleton className="h-10 flex-1 rounded-md bg-gray-200" />
              <div className="flex flex-wrap gap-2 md:flex-nowrap">
                {[1, 2, 3].map((i) => (
                  <Skeleton key={i} className="h-10 w-full md:w-[180px] rounded-md bg-gray-200" />
                ))}
                <Skeleton className="h-10 w-32 ml-auto rounded-md bg-gray-200" />
              </div>
            </div>
          </CardContent>
        </Card>
