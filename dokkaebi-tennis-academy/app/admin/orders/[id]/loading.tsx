      ...
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <Skeleton className="mt-2 h-4 w-48 rounded bg-background dark:bg-card animate-pulse" />
          </div>
          ...
          {[...Array(3)].map((_, i) => (
            <Card key={i} className="border border-border bg-card dark:bg-card shadow-sm">
              ...
              <CardContent className="space-y-3">
                {[...Array(3)].map((_, j) => (
                  <div key={j}>
                    <Skeleton className="h-4 w-24 rounded bg-background dark:bg-card animate-pulse" />
            ...
            <div className="rounded-md border">
              <div className="border-b bg-muted/50 p-3">
                <div className="flex justify-between">
                  <Skeleton className="h-4 w-32 bg-background dark:bg-card animate-pulse rounded" />
                  <Skeleton className="h-4 w-16 bg-background dark:bg-card animate-pulse rounded" />
                  <Skeleton className="h-4 w-16 bg-background dark:bg-card animate-pulse rounded" />
                  <Skeleton className="h-4 w-16 bg-background dark:bg-card animate-pulse rounded" />
                </div>
              </div>
        ...
        <Card className="border border-border bg-card dark:bg-card shadow-sm">
          ...
          <CardContent>
            <Skeleton className="h-[100px] w-full rounded bg-background dark:bg-card animate-pulse" />
              ...
              {[...Array(3)].map((_, i) => (
                <div key={i} className="flex">
                  ...
                  <div className="flex-1 pb-8">
                    ...
                    <Skeleton className="mt-2 h-4 w-full bg-background dark:bg-card animate-pulse rounded" />
                  </div>
                </div>
              ))}
            </div>
