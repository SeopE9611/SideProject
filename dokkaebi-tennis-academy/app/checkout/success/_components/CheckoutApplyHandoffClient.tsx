      ...
      <div className="w-full max-w-lg">
        ...
        <Card className="border-border/60 shadow-sm">
          <CardHeader className="text-center pb-4">
            <CardTitle className="text-2xl font-semibold tracking-tight">주문 완료</CardTitle>
          ...
          <CardContent className="space-y-6">
            <div className="rounded-lg border border-border bg-muted/40 p-4">
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-muted-foreground">주문 번호</span>
                <span className="font-mono text-sm font-semibold tracking-wide">{orderId}</span>
              </div>
            </div>
            ...
            {!cancelled ? (
              <div className="flex items-start gap-3 rounded-lg bg-blue-50 p-4 dark:bg-blue-950/20">
                ...
                <div className="flex-1 space-y-1">
                  <p className="text-sm font-medium text-blue-900 dark:text-blue-100">자동 이동 중</p>
              ...
              <div className="flex items-start gap-3 rounded-lg bg-muted/50 p-4">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  자동 이동이 취소되었습니다. 준비되면 아래 버튼으로 이동해주세요.
                </p>
              </div>
            )}

            <p className="text-xs text-muted-foreground leading-relaxed">
              주문 내역은 마이페이지에서 언제든지 확인할 수 있으며, 신청서 작성은 나중에 이어서 진행하실 수 있습니다.
            </p>
          </CardContent>
