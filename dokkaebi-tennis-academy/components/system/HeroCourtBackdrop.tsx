...
export default function HeroCourtBackdrop({ className }: HeroCourtBackdropProps) {
  return (
    <svg className={cn('pointer-events-none absolute inset-0', className)} viewBox="0 0 1200 600" fill="none" aria-hidden="true" preserveAspectRatio="xMidYMid slice">
