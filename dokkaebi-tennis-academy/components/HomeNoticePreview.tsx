  ...
  return (
    <section className="mt-8 sm:mt-10 md:mt-12">
      <div className="mb-4 sm:mb-5 flex items-center justify-between">
        <h2 className="text-xl sm:text-2xl font-semibold text-slate-900 dark:text-white">공지사항</h2>
        <Link className="text-sm sm:text-base text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white transition-colors" href="/board/notice">
          더보기
        </Link>
      </div>
      <ul className="space-y-3 sm:space-y-4">
        {isLoading ? (
          ...
          <li key="empty" className="py-10 sm:py-12 text-center text-sm sm:text-base text-slate-500 dark:text-slate-400">
            등록된 공지사항이 없습니다
          </li>
        )}
      </ul>
